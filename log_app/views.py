...
from log_app.models import Fuel, Log, LogMpesa, MyUser, Profile 
...
def home(request):
    ...
    print(fuels)
    return render(request,'index.html',{"fuels":fuels,"users":users,"logs":logs,"today_fuel_log":today_fuel_log,"prof":prof})