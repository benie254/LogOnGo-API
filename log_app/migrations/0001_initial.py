# Generated by Django 4.1 on 2022-10-08 08:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_litres_sold_today', models.DecimalField(blank=True, decimal_places=2, max_digits=18, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pump_name', models.CharField(choices=[('Pump One', 'Pump One'), ('Pump Two', 'Pump Two'), ('Pump Three', 'Pump Three'), ('Pump Four', 'Pump Four')], default='', max_length=60)),
                ('initial_litres_in_tank', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('date', models.DateField(blank=True, default=django.utils.timezone.now, null=True)),
                ('balance', models.DecimalField(blank=True, decimal_places=2, max_digits=18, null=True)),
                ('updated_balance', models.DecimalField(blank=True, decimal_places=2, max_digits=18, null=True)),
                ('balance_yesterday', models.DecimalField(blank=True, decimal_places=2, max_digits=18, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logged_by', models.CharField(blank=True, max_length=120, null=True)),
                ('admin_name', models.CharField(default='', max_length=120)),
                ('admin_email', models.EmailField(default='', max_length=120)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=django.utils.timezone.now)),
                ('transaction_number', models.CharField(default=0, max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=django.utils.timezone.now)),
                ('fuel_name', models.CharField(blank=True, max_length=60, null=True)),
                ('price_per_litre', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nature', models.CharField(choices=[('equipment', 'equipment'), ('injury', 'injury'), ('emergency', 'emergency')], max_length=100)),
                ('description', models.TextField(max_length=5000)),
                ('your_name', models.CharField(blank=True, max_length=120, null=True)),
                ('your_email', models.EmailField(blank=True, max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_name', models.CharField(blank=True, max_length=60, null=True)),
                ('total_fuel_received_today', models.PositiveIntegerField(blank=True, default=0, null=True)),
                ('fuel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='log_app.fuel')),
            ],
        ),
        migrations.CreateModel(
