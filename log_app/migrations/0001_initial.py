    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employee_id', models.PositiveIntegerField(choices=[(12345, 12345), (67891, 67891), (102030, 102030), (405060, 405060), (708090, 708090)], unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logged_by', models.CharField(blank=True, max_length=120, null=True)),
                ('site_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='log_app.petrolstation')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eod_reading_yesterday', models.DecimalField(blank=True, decimal_places=2, max_digits=19)),
                ('total_litres_sold', models.DecimalField(blank=True, decimal_places=2, max_digits=18)),
                ('balance', models.DecimalField(blank=True, decimal_places=2, max_digits=18)),
                ('updated_balance', models.DecimalField(blank=True, decimal_places=2, max_digits=18)),
                ('balance_yesterday', models.DecimalField(blank=True, decimal_places=2, max_digits=18)),
                ('first_logged', models.DateTimeField(auto_now_add=True, null=True)),
                ('last_edited', models.DateTimeField(auto_now=True, null=True)),
                ('logged_by', models.CharField(blank=True, max_length=120, null=True)),
