...
from log_app.models import LogCreditCard, MyUser, Log, LogMpesa, Fuel, FuelReceived, Incident, Contact, Announcement, Pump
...
admin.site.register(LogMpesa)
admin.site.register(FuelReceived)
