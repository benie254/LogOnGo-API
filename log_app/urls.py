...
urlpatterns = [
    ...
    url(r'^fuel-logs-ii-today/$', api_views.TodayFuelLogsTwo.as_view(),name='fuel_logs_ii_today'),
    url(r'^fuel-logs-iii-today/$', api_views.TodayFuelLogsThree.as_view(),name='fuel_logs_iii_today'),
    url(r'^fuel-logs-iv-today/$', api_views.TodayFuelLogsFour.as_view(),name='fuel_logs_iv_today'),
    url(r'^fuel-logs-yesterday/$', api_views.YesterdayFuelLogs.as_view(),name='fuel_logs_yesterday'),
    ...
    url(r'^total-fuel-received-today/$', api_views.TotalFuelReceivedToday.as_view(),name='total_fuel_today'),
    url(r'^fuel-received-today/info/$', api_views.FuelReceivedTodayInfo.as_view(),name='fuel_received_today'),
    url(r'^log-details/(\d+)$', api_views.LogDetails.as_view(),name='diesel_log_details'),
