...
urlpatterns = [
    ...
    # content URLS
    url(r'^announcements/add/$',api_views.AddAnnouncements.as_view(),name="add-announcements"),
    ...
    url(r'^fuel/remove/(\d+)',api_views.RemoveFuel.as_view(),name='remove-fuel'),
    ...
    url(r'^logs/remove/(\d+)$', api_views.RemoveLog.as_view(),name='remove-log'),
    ...
    url(r'^logs/mpesa/remove/(\d+)$', api_views.RemoveMpesa.as_view(),name='remove-mpesa'),
    ...
    url(r'^logs/card/remove/(\d+)$', api_views.RemoveCard.as_view(),name='remove-card'),
